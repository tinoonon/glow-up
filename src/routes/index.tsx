...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Oferta Exclusiva — Mentoria em GMentoria Vip Exclusiva" },
      {
        name: "description",
        content:
          "Acelere seus resultados no curso de tranças profissionais com a Mentoria Vip Exclusiva. Oferta única.",
      },
    ],
  }),
...
const IconWhats = () => (
  <svg viewBox="0 0 24 24" fill="none" className="w-7 h-7">
    <path
      d="M12 2a10 10 0 0 0-8.6 15.07L2 22l5.07-1.32A10 10 0 1 0 12 2Zm5.3 14.2c-.22.62-1.3 1.2-1.79 1.24-.45.04-1 .2-3.4-.74-2.85-1.13-4.65-4.06-4.8-4.26-.13-.2-1.13-1.5-1.13-2.86 0-1.36.71-2.03.97-2.31a1 1 0 0 1 .73-.34h.52c.17 0 .4-.06.62.47.22.55.74 1.9.81 2.04.07.13.11.29.02.47-.09.18-.13.29-.27.45-.13.16-.28.36-.4.49-.13.13-.27.27-.12.53.16.27.71 1.18 1.53 1.91 1.06.95 1.96 1.24 2.23 1.38.27.13.43.11.6-.07.16-.18.69-.81.88-1.08.18-.27.36-.22.6-.13.25.09 1.6.76 1.87.9.27.13.45.2.52.31.07.11.07.65-.16 1.27Z"
      fill="currentColor"
    />
  </svg>
);
...
const IconCommunity = () => (
  <svg viewBox="0 0 24 24" fill="none" className="w-7 h-7">
    ...
    <circle cx="17" cy="9.5" r="2.5" fill="currentColor" opacity=".7" />
    <path
      d="M3 19c0-3 2.7-5 6-5s6 2 6 5v1H3v-1Zm12.5-.5c0-1.4-.5-2.6-1.4-3.5 2.7.1 4.9 1.7 4.9 4v1H15.5Z"
      fill="currentColor"
    />
  </svg>
);
...
function UpsellPage() {
  const benefits = [
    {
      Icon: IconWhats,
      title: "Mentoria Vip Exclusiva no WhatsApp",
      desc: "Suporte direto comigo e com a equipe sempre que precisar — respostas em minutos.",
    },
    {
      Icon: IconLive,
      title: "Lives ao Vivo Semanais",
      desc: "Tire suas dúvidas em tempo real e veja demonstrações práticas exclusivas.",
    },
    {
      Icon: IconMoney,
      title: "Captação de Clientes",
      desc: "Estratégias reais para encher sua agenda e aumentar seu ticket médio.",
    },
    {
      Icon: IconCommunity,
      title: "Comunidade de Apoio",
      desc: "Conecte-se com outras alunas, troque experiências e cresça em grupo.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-black text-white font-[Montserrat,sans-serif] relative overflow-hidden">
      <link
        href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;600;700;800;900&family=Anton&display=swap"
        rel="stylesheet"
      />
      ...
      <div className="pointer-events-none absolute top-[40%] -right-40 w-[500px] h-[500px] rounded-full bg-[#e30613] opacity-15 blur-[120px]" />
      ...
      <div className="relative w-full bg-gradient-to-r from-[#b8050f] via-[#e30613] to-[#b8050f] text-white text-center py-3 px-4 text-xs sm:text-sm font-black tracking-[0.18em] uppercase border-b border-[#ff4757]/40">
        <span className="inline-flex items-center gap-2">
          <IconFire /> Oferta Exclusiva — Aparece Apenas Uma Vez <IconFire />
        </span>
      </div>
      ...
      <main className="relative mx-auto w-full max-w-[620px] px-5 pt-10 pb-8">
        ...
        <section className="text-center">
          <h1
            className="text-[34px] leading-[1.05] sm:text-5xl font-black uppercase tracking-tight"
            style={{ fontFamily: "'Anton', Montserrat, sans-serif", letterSpacing: "0.5px" }}
          >
            ...
            <span
              ...
              style={{
                backgroundImage:
                  "linear-gradient(135deg,#ff2e63 0%,#e91e63 40%,#ff7eb6 100%)",
              }}
            >
              Acelere seus resultados com a Mentoria Vip Exclusiva!
            </span>
          </h1>

          <p className="mt-5 text-gray-300 text-base leading-relaxed max-w-[520px] mx-auto">
            Você acabou de garantir seu curso. Agora <strong className="text-white">destrave o próximo nível</strong>: suporte direto, comunidade ativa e estratégias para faturar de verdade com tranças.
          </p>
        ...
        <section className="mt-10 grid gap-4">
          {benefits.map(({ Icon, title, desc }, i) => (
            <div
              key={title}
              className="group relative rounded-2xl p-[1.5px] bg-gradient-to-br from-[#e91e63]/70 via-[#e91e63]/10 to-transparent transition-transform hover:-translate-y-[2px]"
            >
              <div className="flex gap-4 items-start bg-[#0a0a0a] rounded-2xl p-5">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    <span className="text-[10px] font-black text-[#e91e63] tracking-widest">
                      0{i + 1}
                    </span>
                    <span className="h-px flex-1 bg-[#e91e63]/30" />
                  </div>
                  <h3 className="mt-1 text-white font-black text-lg leading-tight">
                    {title}
                  </h3>
        ...
        <section className="relative mt-12">
          ...
          <div className="relative rounded-3xl p-[2px] bg-gradient-to-b from-[#ff2e63] via-[#e91e63] to-[#7a0d34] shadow-[0_0_50px_rgba(233,30,99,0.45)]">
            <div className="rounded-3xl bg-gradient-to-b from-[#15080d] via-black to-[#15080d] p-7 text-center">
              <p className="uppercase text-xs sm:text-sm tracking-[0.3em] text-gray-400 font-bold">
                Adquira Agora Mesmo
              </p>
              ...
              <div className="mt-5 flex flex-col items-center gap-2">
                <div className="text-center">
                  ...
                  <p className="text-xl text-gray-400 font-bold line-through decoration-[#e30613] decoration-[3px]">
                    R$ 97,00
                  </p>
                </div>
                <div className="text-center">
                  ...
                  <p
                    className="text-6xl sm:text-7xl font-black leading-none bg-clip-text text-transparent"
                    style={{
                      fontFamily: "'Anton', sans-serif",
                      backgroundImage:
                        "linear-gradient(180deg,#ffffff 0%,#ffd6e3 50%,#e91e63 100%)",
                    }}
                  >
                    R$19,90
                  </p>
              ...
              {/* CTA principal */}
              <a
                href="https://pay.lowify.com.br/checkout?product_id=8lSodd"
              ...
              >
                ...
                <div className="relative flex items-center justify-center gap-2 py-5 px-4 text-white font-black uppercase text-base sm:text-lg tracking-wide drop-shadow-[0_2px_4px_rgba(0,0,0,0.4)]">
                  Sim! Quero entrar na Mentoria Exclusiva 
                  <IconArrow />
                </div>
              ...
              <ul className="mt-5 grid grid-cols-2 gap-2 text-left">
                {["Acesso imediato", "Suporte VIP", "Lives semanais", "7 dias de garantia"].map((t) => (
                  <li key={t} className="flex items-center gap-2 text-xs text-gray-300 font-semibold">
                    <span className="w-5 h-5 rounded-full bg-[#22c55e]/20 text-[#22c55e] flex items-center justify-center">
                      <IconCheck />
                    </span>
                    {t}
                  </li>
              ...
              <Link
                to="/downsell"
                className="block mt-6 text-gray-500 hover:text-gray-300 text-xs sm:text-sm underline underline-offset-4 transition"
              >
                Não obrigada, prefiro continuar sem suporte
              </Link>
            </div>
          </div>
        ...
        <section className="mt-8 relative rounded-2xl overflow-hidden border border-[#e91e63]/30 bg-gradient-to-br from-[#0d0d0d] to-[#1a0510] p-6 sm:p-8">
          <div className="flex flex-col sm:flex-row items-center gap-6">
            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              <p className="text-gray-400 text-sm mt-2 leading-relaxed">
                Não gostou? Devolvemos 100% do valor. Sem perguntas, sem burocracia.
              </p>
            </div>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-white/5 grid grid-cols-3 gap-4 sm:gap-6">
            {[
              ...
              { Icon: IconStar, label: "+10 mil", sublabel: "Alunas" },
      ...
      <div className="relative w-full bg-gradient-to-r from-[#b8050f] via-[#e30613] to-[#b8050f] text-white text-center py-4 px-4 text-xs sm:text-sm font-black uppercase tracking-[0.15em] border-t border-[#ff4757]/40">
        <span className="inline-flex items-center gap-2">
          ⏳ Esta Oferta Desaparece para Sempre Ao Sair Desta Página
        </span>
      </div>
    </div>
  );
